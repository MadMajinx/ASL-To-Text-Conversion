...
class Application:
    def __init__(self):
        ...
        self.json_file = open(r'E:\VS Code Workspace\Projects3\Sign2Text2\model\model-bw.json', "r")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights(r'E:\VS Code Workspace\Projects3\Sign2Text2\model\model-bw.h5')

        self.json_file_dru = open(r'E:\VS Code Workspace\Projects3\Sign2Text2\model\model-bw_dru.json', "r")
        self.model_json_dru = self.json_file_dru.read()
        self.json_file_dru.close()
        self.loaded_model_dru = model_from_json(self.model_json_dru)
        self.loaded_model_dru.load_weights(r'E:\VS Code Workspace\Projects3\Sign2Text2\model\model-bw_dru.h5')

        self.json_file_tkdi = open(r'E:\VS Code Workspace\Projects3\Sign2Text2\model\model-bw_tkdi.json', "r")
        self.model_json_tkdi = self.json_file_tkdi.read()
        self.json_file_tkdi.close()
        self.loaded_model_tkdi = model_from_json(self.model_json_tkdi)
        self.loaded_model_tkdi.load_weights(r'E:\VS Code Workspace\Projects3\Sign2Text2\model\model-bw_tkdi.h5')

        self.json_file_smn = open(r'E:\VS Code Workspace\Projects3\Sign2Text2\model\model-bw_smn.json', "r")
        self.model_json_smn = self.json_file_smn.read()
        self.json_file_smn.close()
        self.loaded_model_smn = model_from_json(self.model_json_smn)
        self.loaded_model_smn.load_weights(r'E:\VS Code Workspace\Projects3\Sign2Text2\model\model-bw_smn.h5')
        ...
        self.photosign = tk.PhotoImage(file=r'E:\VS Code Workspace\Projects3\Sign2Text2\pics\signs.png')
